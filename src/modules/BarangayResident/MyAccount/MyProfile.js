        ...
        <div className="MyProfile_container">
                ...
                <div className="upper_profile">
                    <div className="MyProfile_img_container">
                        <div className="image_holder">
                            <img src={profileImage} alt="" id="profile_img" className="profile_img" />
                        </div>
                        <input type="file" accept="image/*" name="image_upload" id="input_image" onChange={(e) => {
                            const reader = new FileReader();
                            reader.onload = () => {
                                if (reader.readyState === 2) {
                                    setProfileImage({ profileImage: reader.result })
                                }
                            }
                            reader.readAsDataURL(e.target.files[0]);
                        }} />
                        <div className="imageLabel_container">
                            <label htmlFor="input_image" className="label_imageUpload">
            ...
            <div className="personal_info">
                            ...
                            <div className="personal_info_col">
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="inputfield_view">
                                        <input type="text" name="first_name" id="first_name" value={first_name} required className="form-control" autoComplete="off" disabled />
                                    </div>
                                </div>
                                <div className="form-group">
                ...
                <div className="editProfile_container">
                    <input type="submit" className="editProfile_btn" value="Edit Personal Information" onClick={edit_personalInfo} />
                </div>
            </div>
            <div className="personal_info">
                <form>
                ...
                <div className="editProfile_container">
                    <input type="submit" className="editProfile_btn" value="Edit Address" onClick={edit_address} />
                </div>
            </div>
            <div className="personal_info">
                <form>
                ...
                <div className="editProfile_container">
                    <input type="submit" className="editProfile_btn" value="Edit Education Background" onClick={edit_educationBackground} />
                </div>
            </div>
            <div className="personal_info">
                <form>
                ...
                <div className="editProfile_container">
                    <input type="submit" className="editProfile_btn" value="Edit Family Background" onClick={edit_familyBackground} />
                </div>
            </div>
