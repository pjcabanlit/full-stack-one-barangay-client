...
function ProcessTable({ data }) {
    ...
    const generate_certificate = (document_type) => {
        <GenerateCertificate document_type={document_type} />
    }
                                ...
                                <TableRow>
                                    <TableCell>
                                        <Grid container>
                                            ...
                                            <Grid item lg={10} >
                                                <Typography className={classes.name}>{row.first_name + " " + row.middle_name + " " + row.last_name + " " + row.prefix}
                                                </Typography>
                                                <Typography>
                                                    {row.address}
                                                </Typography>
                                    ...
                                    <TableCell><button className="approve_btn" onClick={() => generate_certificate(row.document_type)}>Check</button></TableCell>
                                    <TableCell>
